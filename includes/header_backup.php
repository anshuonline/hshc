...
<!-- Luxury Navigation Bar (Glassmorphism) -->
<nav class="fixed w-full z-[100] transition-all duration-500 glass-effect-dark" id="navbar">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-24 transition-all duration-500" id="nav-container">
            ...
            <div class="flex-shrink-0 flex items-center">
                <a href="index.php" class="text-3xl font-serif font-bold text-white tracking-[0.2em] uppercase hover:text-accent transition-colors duration-300">
            ...
            <div class="hidden md:flex items-center space-x-8">
                <a href="index.php" class="text-xs font-medium text-white tracking-[0.2em] uppercase hover:text-accent transition-colors duration-300 nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'index.php' ? 'active-link' : ''; ?>">Home</a>
                <a href="index.php#about" class="text-xs font-medium text-white tracking-[0.2em] uppercase hover:text-accent transition-colors duration-300 nav-link">About</a>
                <a href="hotels.php" class="text-xs font-medium text-white tracking-[0.2em] uppercase hover:text-accent transition-colors duration-300 nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'hotels.php' ? 'active-link' : ''; ?>">Retreat</a>
                <a href="reviews.php" class="text-xs font-medium text-white tracking-[0.2em] uppercase hover:text-accent transition-colors duration-300 nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'reviews.php' ? 'active-link' : ''; ?>">Reviews</a>
                
                <?php if (isset($_SESSION['user_logged_in']) && $_SESSION['user_logged_in']): ?>
                    <a href="book-now.php" class="text-xs font-medium text-white tracking-[0.2em] uppercase hover:text-accent transition-colors duration-300 nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'book-now.php' ? 'active-link' : ''; ?>">Book Now</a>
                    
                    <!-- User Dropdown -->
                    <div class="relative user-dropdown ml-4">
                        <button type="button" class="flex items-center space-x-2 text-white hover:text-accent focus:outline-none transition-colors duration-300" id="user-menu-button">
                            <span class="w-10 h-10 rounded-full border border-accent flex items-center justify-center font-serif text-lg bg-black/30">
                                <?php 
                        ...
                        <div class="dropdown-menu border border-white/10 glass-effect-dark" id="user-dropdown-menu">
                            ...
                            <div class="py-2">
                                <a href="profile.php" class="block px-4 py-2 text-sm text-gray-300 hover:bg-white/5 hover:text-accent transition-colors">Profile</a>
                                <a href="my-bookings.php" class="block px-4 py-2 text-sm text-gray-300 hover:bg-white/5 hover:text-accent transition-colors">My Bookings</a>
                                <a href="logout.php" class="block px-4 py-2 text-sm text-gray-300 hover:bg-white/5 hover:text-accent transition-colors">Sign out</a>
                            </div>
                        </div>
                    </div>
                <?php elseif (isset($_SESSION['admin_logged_in']) && $_SESSION['admin_logged_in']): ?>
                    ...
                    <div class="relative user-dropdown ml-4">
                        <button type="button" class="flex items-center space-x-2 text-white hover:text-accent focus:outline-none transition-colors duration-300" id="admin-menu-button">
                            <span class="w-10 h-10 rounded-full border border-accent flex items-center justify-center font-serif text-lg bg-accent/10 text-accent">
                                <?php 
                        ...
                        <div class="dropdown-menu border border-white/10 glass-effect-dark" id="admin-dropdown-menu">
                            ...
                            <div class="py-2">
                                <a href="admin/dashboard.php" class="block px-4 py-2 text-sm text-gray-300 hover:bg-white/5 hover:text-accent transition-colors">Dashboard</a>
                                <a href="admin/logout.php" class="block px-4 py-2 text-sm text-gray-300 hover:bg-white/5 hover:text-accent transition-colors">Sign out</a>
                            </div>
                        </div>
                    </div>
                <?php else: ?>
                    <div class="flex items-center space-x-6 ml-4 border-l border-white/20 pl-6">
                        <a href="login.php" class="text-xs font-medium text-white tracking-[0.2em] uppercase hover:text-accent transition-colors duration-300">Sign In</a>
                        <a href="register.php" class="text-xs font-medium text-primary bg-accent hover:bg-accent-light px-6 py-3 rounded-none tracking-[0.2em] uppercase transition-all duration-300">Reserve</a>
                    </div>
                <?php endif; ?>
            </div>
